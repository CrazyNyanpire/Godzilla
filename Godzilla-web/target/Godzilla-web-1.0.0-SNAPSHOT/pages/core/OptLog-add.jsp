...
<form class="form-horizontal">
	           ...
	           <div class="form-group">
                    ...
                    <div class="col-lg-9">
                           <input name="comment" style="display:inline; width:94%;" class="form-control"  type="text"  id="commentID" />
    </div>
</div>
	           <div class="form-group">
                    <label class="col-lg-3 control-label">optName:</label>
                    <div class="col-lg-9">
                           <input name="optName" style="display:inline; width:94%;" class="form-control"  type="text"  id="optNameID" />
    </div>
</div>
</form>
