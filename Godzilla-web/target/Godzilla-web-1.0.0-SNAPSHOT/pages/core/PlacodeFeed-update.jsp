    ...
    <div class="col-lg-9">
      ...
      <span class="required">*</span>
	           ...
	           <div class="form-group">
                    ...
                    <div class="col-lg-9">
                           <input name="shippingDate" style="display:inline; width:94%;" class="form-control"  type="text" readonly  id="shippingDateID" dataType="Require"/>
                           <span class="required">*</span>
    </div>
</div>
...
<div class="form-group">
                    ...
                    <div class="col-lg-9">
                           <input name="deliveryDate" style="display:inline; width:94%;" class="form-control"  type="text" readonly  id="deliveryDateID" dataType="Require"/>
                           <span class="required">*</span>
    </div>
</div>
  	           <div class="form-group">
