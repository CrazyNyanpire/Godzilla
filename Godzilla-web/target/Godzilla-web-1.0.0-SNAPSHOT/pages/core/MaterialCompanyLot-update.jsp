...
<form class="form-horizontal">
	           ...
	           <div class="form-group">
                    <label class="col-lg-3 control-label">materialLot:</label>
                    <div class="col-lg-9">
                           <input name="materialLot" style="display:inline; width:94%;" class="form-control"  type="text"  id="materialLotID" />
    </div>
</div>
	           <div class="form-group">
                    <label class="col-lg-3 control-label">lotNo:</label>
                    <div class="col-lg-9">
                           <input name="lotNo" style="display:inline; width:94%;" class="form-control"  type="text"  id="lotNoID" />
    </div>
</div>
</form>
