	...
	*/
	$("input[name='currStatus']").change(function() { 
		...
		if($(this).val()=="TotalWIP"){
			...
			grid.getGrid().searchConditiontwo['currStatus']="'Running'";
		}
		else if($(this).val()=="CusDisp"){
			gridchange(grid);
			PageLoader.initGridPanelone();
			grid.getGrid().searchConditionone['currStatus']="'Cus. Disp'";
		}else if($(this).val()=="EngDisp"){
			gridchange(grid);
			PageLoader.initGridPanelone();
			grid.getGrid().searchConditionone['currStatus']="'Eng. Disp'";
		}else{
			gridchange(grid);
			PageLoader.initGridPanelone();
		}	
	   ...
	   //
	    ...
	    initGridPanelone: function(){
	         ...
	         return grid.grid({
	                identity:"id",
	                buttons: [
								{content: '<button class="btn btn-primary" type="button"><span class="glyphicon "><span style="margin-left:5px;">Release</button>', action: 'Release'},
		                        ...
		                        {content: '<button class="btn btn-primary" type="button"><span class="glyphicon "><span style="margin-left:5px;">Get<span class="God_span_nbsp"/>Traveler</button>', action: 'Get_Traveler'},
		                        {content: '<button class="btn btn-primary" type="button"><span class="glyphicon "><span style="margin-left:5px;">Get<span class="God_span_nbsp"/>Bom</button>', action: 'Get_Bom'},		                        
		                        {content: '<button class="btn btn-primary" type="button"><span class="glyphicon "><span style="margin-left:5px;">Lot<span class="God_span_nbsp"/>Summary</button>', action: 'Lot_Summary'},
	                    ],
	                ...
	                columns: [
		                      ...
		                      { title: 'Lot Type.', name: 'lotType', width: width},
   	                          { title: 'Strip#', name: 'stripQtyIn', width: width},
	                   ...
	                   'Change_Lot_Type': function(event, data){
	                    ...
	                    'Get_Traveler': function(event, data){
	                        ...
	                        window.open("/pages/RunCard.jsp?id="+indexs[0]);
	                    },
	    ...
	    initGridPaneltwo: function(){
	         ...
	         return grid.grid({
	                ...
	                buttons: [
		                        ...
		                        {content: '<button class="btn btn-primary" type="button"><span class="glyphicon "><span style="margin-left:5px;">Track-Out</button>', action: 'Track_Out'},
		                        {content: '<button class="btn btn-primary" type="button"><span class="glyphicon "><span style="margin-left:5px;">Cus<span class="God_span_nbsp"/>Hold</button>', action: 'Cus_Hold'},
		                        {content: '<button class="btn btn-primary" type="button"><span class="glyphicon "><span style="margin-left:5px;">Eng<span class="God_span_nbsp"/>Hold</button>', action: 'Eng_Hold'},
		                        {content: '<button class="btn btn-primary" type="button"><span class="glyphicon "><span style="margin-left:5px;">Future<span class="God_span_nbsp"/>Hold</button>', action: 'Future_Hold'},
		                        {content: '<button class="btn btn-primary" type="button"><span class="glyphicon "><span style="margin-left:5px;">Change<span class="God_span_nbsp"/>Lot<span class="God_span_nbsp"/>Type</button>', action: 'Change_Lot_Type'},
		                        {content: '<button class="btn btn-primary" type="button"><span class="glyphicon "><span style="margin-left:5px;">Get<span class="God_span_nbsp"/>Traveler</button>', action: 'Get_Traveler'},
		                        {content: '<button class="btn btn-primary" type="button"><span class="glyphicon "><span style="margin-left:5px;">Get<span class="God_span_nbsp"/>Bom</button>', action: 'Get_Bom'},		                        
		                        {content: '<button class="btn btn-primary" type="button"><span class="glyphicon "><span style="margin-left:5px;">Lot<span class="God_span_nbsp"/>Summary</button>', action: 'Lot_Summary'},
	                ...
	                columns: [
                     		  { title: 'Lot N.', name: 'lotNo', width: width},
		                      { title: 'Product Name', name: 'partNumber', width: width},
		                      { title: 'Equipment', name: 'equipment', width: width},
   	                       	  { title: 'Qty', name: 'qtyIn', width: width},
   	                       	  { title: 'Strip #', name: 'stripQtyIn', width: width},
		                      { title: 'Step', name: 'Step', width: width},
		                      ...
		                      { title: 'Lot Type', name: 'lotType', width: width},
   	                          { title: 'Sub. Batch', name: 'subBatch', width: width},
		                      { title: 'Entry Date', name: 'entryDate', width: 110},
		                      { title: 'Entry Time', name: 'entryTime', width: 110},
		                      { title: 'User', name: 'userName', width: width},		                     
		                      { title: 'Inv Loc.', name: 'stockPos', width: width}
	    ...
	    initGridPanel: function(){
	         ...
	         return grid.grid({
	                ...
	                buttons: [
		                        ...
		                        {content: '<button class="btn btn-primary" type="button"><span class="glyphicon "><span style="margin-left:5px;">Track-In</button>', action: 'Track_In'},
		                        {content: '<button class="btn btn-primary" type="button"><span class="glyphicon "><span style="margin-left:5px;">Cus<span class="God_span_nbsp"/>Hold</button>', action: 'Cus_Hold'},
		                        {content: '<button class="btn btn-primary" type="button"><span class="glyphicon "><span style="margin-left:5px;">Eng<span class="God_span_nbsp"/>Hold</button>', action: 'Eng_Hold'},
		                        {content: '<button class="btn btn-primary" type="button"><span class="glyphicon "><span style="margin-left:5px;">Fut<span class="God_span_nbsp"/>Hold</button>', action: 'Future_Hold'},
	    ...
	    Track_In: function(id, grid){
	        ...
	        $.get('<%=path%>/SubstrateTrackIn.jsp').done(function(html){
	               dialog.find('.modal-body').html(html);
	               self.initPage(dialog.find('form'));
	               $.get( '${pageContext.request.contextPath}/SubstrateProcess/get/' + id + '.koala').done(function(json){
                       json = json.data;
	                ...
	                dialog.find('#save').on('click',{grid: grid}, function(e){
	                    ...
	                    var restring=JSON.stringify(rs);
	  	          		debugger;
	                    $.post('${pageContext.request.contextPath}/SubstrateProcess/Process/trackIn.koala', "data="+restring).done(function(result){
	                        if(result.result == 'success'){
	                            dialog.modal('hide');
	                            e.data.grid.data('koala.grid').refresh();
	                            e.data.grid.message({
	    ...
	    Track_Out: function(id, grid){
	        ...
	        $.get('<%=path%>/SubstrateTrackOut.jsp').done(function(html){
	               dialog.find('.modal-body').html(html);
	               self.initPage(dialog.find('form'));
	               $.get( '${pageContext.request.contextPath}/SubstrateProcess/get/' + id + '.koala').done(function(json){
                       json = json.data;
	    ...
	    Abort_Step: function(id, grid){
	        var self = this;
	        var dialog = $('<div class="modal fade"><div style="width: 40%;" class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title">Abort_Step</h4></div><div class="modal-body"><p>One fine body&hellip;</p></div><div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">取消</button><button type="button" class="btn btn-success" id="save">提交</button></div></div></div></div>');
	        $.get('<%=path%>/WaferStart.jsp').done(function(html){
	               dialog.find('.modal-body').html(html);
	               self.initPage(dialog.find('form'));
	               $.get( '${pageContext.request.contextPath}/SubstrateProcess/get/' + id + '.koala').done(function(json){
                       json = json.data;
