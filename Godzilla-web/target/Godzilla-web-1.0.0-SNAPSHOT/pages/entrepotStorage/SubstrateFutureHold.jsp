...
$.ajax({
	async:false,
	url: '${pageContext.request.contextPath}/SubstrateProcess/getFutureStations/'+id+'.koala',
	type: 'POST',
	dataType: 'json',
})
.done(function(msg) {
...
$.ajax({
	async:false,
	url: '${pageContext.request.contextPath}/SubstrateProcess/Process/getCusDisps.koala',
	type: 'POST',
	dataType: 'json',
})
.done(function(msg) {
	...
	$.ajax({
		async:false,
		url: '${pageContext.request.contextPath}/WaferProcess/Process/getEngDisps.koala',
		type: 'POST',
		dataType: 'json',
	})
	.done(function(msg) {
