...
<p>Track Out:</p>
	           <div class="form-group">
                    <div class="col-lg-9 col-lg-offset-2 center" style="overflow: auto;">
                    <table id="God_Track_In_append" class="table table-bordered God_Track_In" style="width:94%">
						<tr>
						...
						<tr>
							<td>01</td>
							<td class="God_text-align-left">基板条数  Strip Qty Out</td>
							<td><input type="text" name="StripQtyOut" placeholder="输入文字..." dataType="Require"></td>
						</tr>
					</table>
    </div>
</div>
