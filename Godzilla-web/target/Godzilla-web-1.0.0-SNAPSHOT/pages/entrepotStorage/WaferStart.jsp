...
<hr/>
<div class="God_waferStartShow">
<p>Wafer Id change:</p>
	<div class="form-group">
		<div class="col-lg-9 col-lg-offset-2" >
            <div style="overflow: auto;width:94%;max-height:240px">
				<table class="table table-bordered God_Track_In God_waferId">
					<tr>
						<th>No</th>
						<th>Wafer Id</th>
						<th>Wafer Qty</th>
...
<div class="God_waferStartHide" style="display:none;">
<p>Start:</p>
 	           <div class="form-group">
                    <label class="col-lg-2 control-label">Start Flow:</label>
                    <div class="col-lg-9">
                    <div class="btn-group select" id="startFlowID"></div>
                           <input type="hidden" name="startFlow" id="startFlowID_" dataType=""/>
