...
<p>Track Out:</p>
	           <div class="form-group">
                    ...
                    <div class="col-lg-9">
                           <input name="inQty" style="display:inline; width:94%;" class="form-control"  type="text" readonly id="inQtyID" dataType=""/>
                           <span class="required">*</span>
    </div>
</div>
	           <div class="form-group">
                    <label class="col-lg-2 control-label">Out Qty:</label>
                    <div class="col-lg-9">
                           <input name="outQty" style="display:inline; width:94%;" class="form-control"  type="text" readonly id="outQtyID" dataType=""/>
                           <span class="required">*</span>
    </div>
</div>
	           <div class="form-group">
                    <label class="col-lg-2 control-label">Wasted:</label>
                    <div class="col-lg-9">
                           <input name="wasted" style="display:inline; width:94%;" class="form-control"  type="text" readonly id="wastedID" dataType=""/>
                           <span>%</span>
                           <span class="required">*</span>
    </div>
</div>
	           <div class="form-group">
                    ...
                    <div class="col-lg-9">
                           <textarea name="comments" style="display:inline; width:94%;" class="form-control"  type="text"  id="commentsID" dataType=""></textarea>
                           <span class="required">*</span>
    </div>
</div>
	           <div class="form-group">
...
$.ajax({
	async:false,
	url: '${pageContext.request.contextPath}/DefineStationProcess/findDefineStationProcessesByType/1.koala',
	type: 'POST',
	dataType: 'json',
})
.done(function(msg) {
