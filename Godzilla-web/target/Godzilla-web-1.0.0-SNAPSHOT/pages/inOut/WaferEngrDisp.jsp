...
<form class="form-horizontal">
	           <div class="form-group">
                    <label class="col-lg-3 control-label">Engineering Disposition:</label>
                    <div class="col-lg-9">
...
<div class="form-group">
				...
				<input name="holdCode" style="display:inline;margin-left:20%;" type="radio"  id="holdCode2" value="RTV" /><span>RTV</span>
				<span class="required">*</span>
</div>

	           <div class="form-group">
                    <label class="col-lg-3 control-label">DisposeTime:</label>
                    <div class="col-lg-9">
	           ...
	           <div class="form-group">
                    <label class="col-lg-3 control-label">HoldTime:</label>
                    <div class="col-lg-9">
                           <input name="holdTimeone" style="display:inline; width:94%;" class="form-control" readonly  type="text"  id="holdTimeoneID" dataType="Require"/>
                           <span class="required">*</span>
    </div>
</div>
	           <div class="form-group">
