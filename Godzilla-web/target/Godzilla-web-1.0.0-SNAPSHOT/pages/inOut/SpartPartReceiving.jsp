...
$(function (){
	$.get('${pageContext.request.contextPath}/SpartPartProcess/pageTotal.koala').done(function(result){
		debugger;
	        ...
	        $.get('<%=path%>/UserInformation.jsp').done(function(html){
	               ...
	               self.initPage(dialog.find('form'));
			        ...
			        dialog.find('#save').on('click',{grid: grid}, function(e){
				    	...
				    	debugger;
				    	$.post('${pageContext.request.contextPath}/SpartPartProcess/Receive/save.koala', "data=" + restring).done(function(result){
	...
	$(".table").one("mouseover", function(){
		$("select[name='kucun']").on('change', function(e){
			...
			$.get('${pageContext.request.contextPath}/SpartPartProcess/getNewLotNo/'+id+'.koala').done(function(json){
				debugger;
