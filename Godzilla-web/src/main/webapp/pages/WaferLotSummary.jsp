...
<h3  style="text-align: center;">Lot Summary</h3>
	...
	<div style="margin:0 auto;width:90%">
        ...
        <label class="control-label" style="width:100px">Customer LotN.:</label>
            <div style="margin-left:15px;float:left;">
            <input name="customerLotNo"  type="text" style="width:180px;" id="customerLotNoID"  />
        	</div>
		<br style="clear:both;"/>
	</div>
	</div>
...
$(function() {
	...
	$.ajax({
		...
		$("input[name='customerLotNo']").val(basicInfo['customerLotNo']);
	});
	$.ajax({
		async:false,
		url: '${pageContext.request.contextPath}/LotSummary/Wafer/getLotSummary/' + id + '.koala',
		type: 'GET',
		dataType: 'json',
	}).done(function(msg) {
		//var msg={};
			        ...
			        PageLoader = {
			            initGridPanel: function(){
			                 ...
			                 return grid.grid({
			                        ...
			                        url:'${pageContext.request.contextPath}/LotSummary/Wafer/getDebit/'+id+'.koala',
			                        columns: [
		        ...
		        PageLoader = {
		            initGridPanel: function(){
		                 ...
		                 return grid.grid({
		                        ...
		                        url:'${pageContext.request.contextPath}/LotSummary/Wafer/getMerge/'+id+'.koala',
		                        columns: [
		                           ...
		                           'modify': function(event, data){
		                                ...
		                                window.open("/pages/WaferLotSummary.jsp?id="+indexs[0]+"&stationId=<%=request.getParameter("stationId")%>");
		                            }
		                 });
		            }
		        };
		        ...
		        PageLoader = {
		            initGridPanel: function(){
		                 ...
		                 return grid.grid({
		                        ...
		                        url:'${pageContext.request.contextPath}/LotSummary/Wafer/getSplit/'+id+'.koala',
		                        columns: [
		...
		$(".glyphicon-info-sign").bind("click",function(){
			...
			var id=$(this).attr("lotId");
			$.get('${pageContext.request.contextPath}/LotSummary/Wafer/getHold/'+id+'.koala').done(function(msg){
		...
		$.get('${pageContext.request.contextPath}/LotSummary/Wafer/getReject/'+id+'.koala').done(function(msg){ 
				...
				+'<th index="1">WaferId</th>'
				+'<th index="2">Qty</th></tr>'
				+'</tbody></table>');
				dialog.modal({
		            keyboard:false
		        }).on({
				...
				debugger;
				var b=1;
				for(var a in msg['data'][0]['waferInfos'])
					{
						dialog.find('.table-rej').append('<tr class="tablecontent"><td>'+b+'</td><td>'+msg['data'][0]['waferInfos'][a]['waferId']+'</td><td>'+msg['data'][0]['waferInfos'][a]['dieQty']+'</td></tr>');
						b++;
					}
			});
		});
