...
<form class="form-horizontal">
	           ...
	           <div class="form-group">
                    ...
                    <div class="col-lg-9">
                           <input name="partId"  type="text" style="display:inline; width:94%;" class="form-control" id="partIdID" dataType="Require"/>
                           <span class="required">*</span>
    </div>
</div>
	           <div class="form-group">
	           ...
	           <div class="form-group">
                    ...
                    <div class="col-lg-9">
                           <input name="partNameCN" readonly style="display:inline; width:94%;" class="form-control"  type="text"  id="partNameCNID" dataType="Require"/>
                           <span class="required">*</span>
    </div>
</div>
	           <div class="form-group">
...
<script type="text/javascript">
	...
	$.ajax({
		async:false,
		url: '${pageContext.request.contextPath}/Material/Indirect/all.koala',
		type: 'POST',
		dataType: 'json',
	})
	.done(function(msg) {
