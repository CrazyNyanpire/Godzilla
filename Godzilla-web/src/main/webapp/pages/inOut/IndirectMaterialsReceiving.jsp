...
$(function (){
	$.get('${pageContext.request.contextPath}/MaterialLot/indirect/pageTotal.koala').done(function(result){
		debugger;
	   ...
	   //
	    ...
	    initGridPanel: function(){
	         ...
	         return grid.grid({
	                ...
	                url:"${pageContext.request.contextPath}/MaterialLot/indirect/pageJson.koala",
	                columns: [
