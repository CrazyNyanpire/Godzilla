...
$(function (){
	$.get('${pageContext.request.contextPath}/MaterialProcess/pageTotal.koala?stationId='+materialTypeId).done(function(result){
		debugger;
	...
	grid.getGrid().searchCondition['stationId']=parseInt(materialTypeId);
    ...
    <td>
          ...
          <label class="control-label" style="width:100px;float:left;text-align:left;padding-left:4%;">Batch No:&nbsp;</label>
            ...
            <input name="batchNo" class="form-control" type="text" style="width:180px;" id="batchNoID"  />
                      ...
                      <label class="control-label" style="width:100px;float:left;text-align:left;padding-left:5%;">Vender:&nbsp;</label>
            <div style="margin-left:15px;float:left;">
