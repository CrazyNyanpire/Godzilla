...
<body style="font-family: 微软雅黑;overflow: hidden;">
	<div class="head" style="background-color: transparent;"></div>
	<div style="margin-top:4%"class="logo">
		<img style="height: 75px;padding-top: 10px;"src="images/logo1.png" />
		<div style="color:#fff">Godzilla系统</div>
	</div>
	<div class="login_con">
		<div class="login_con_L" style="box-shadow: 0px 0px 50px #ccc;">
			<img src="images/background/rdn_53ad42b1b231b.jpg" />
		</div>
		<div class="login_con_R" style="box-shadow: 0px 0px 50px #ccc;background-color: #fff;opacity: 0.89;">
			<h4 style="padding-left:20px;margin:0;">登录</h4>
			<FORM id="loginFormId" method=post action="j_spring_security_check" class="form-horizontal">
				<div class="form-group input-group">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                    <input type="text" class="form-control" placeholder="用户名" autocomplete="off" name="j_username" id="j_username" value="admin${j_username }">
				</div>
                <div class="form-group input-group">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                    <input type="password" name="j_password" id="j_password" class="form-control" placeholder="密码" autocomplete="off" value="admin${j_password }"/>
                </div>
				<div class="form-group input-group">
	...
	<!--<video autoplay="autoplay" loop="loop" src="http://192.168.1.35:82/testll/hv_video.ogv" style="width: 100%;position: absolute;top: 0;z-index: -1000;height: auto;"></video>-->
	<video autoplay="autoplay" loop="loop" src="./video/hv_video.ogv" style="width: 100%;position: fixed;top: 0;z-index: -1000;height: auto;"></video> 
	<div style="color: #fff;margin: 6% auto 0;" class="login_footer">Godzilla Copyright © 2014</div>
	<script>
    $(function(){
