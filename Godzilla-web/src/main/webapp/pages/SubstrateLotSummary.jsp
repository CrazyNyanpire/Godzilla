...
<h3  style="text-align: center;">Lot Summary</h3>
	...
	<div style="margin:0 auto;width:90%">
        <label class="control-label">Lot N:</label>
            ...
            <input name="lotNo"  type="text" style="width:180px;" id="lotNoID"  />
        	</div>
        <label class="control-label" style="width:100px">Bantch N.:</label>
            <div style="margin-left:15px;float:left;">
            <input name="batchNo"  type="text" style="width:180px;" id="batchNoID"  />
        	</div>
        <label class="control-label">Sup.Lot N.:</label>
            <div style="margin-left:15px;float:left;">
...
$(function() {
	...
	$.ajax({
		async:false,
		url: '${pageContext.request.contextPath}/SubstrateProcess/get/' + id + '.koala',
		type: 'GET',
		dataType: 'json',
	}).done(function(msg) {
		debugger;
		basicInfo=msg['data'];
		$("input[name='lotNo']").val(basicInfo['lotNo']);
		$("input[name='batchNo']").val(basicInfo['batchNo']);
		$("input[name='customerLotNo']").val(basicInfo['customerLotNo']);
	});
	$.ajax({
		async:false,
		url: '${pageContext.request.contextPath}/LotSummary/Substrate/getLotSummary/' + id + '.koala',
		type: 'GET',
		dataType: 'json',
	}).done(function(msg) {
		//var msg={};
			        ...
			        PageLoader = {
			            initGridPanel: function(){
			                 ...
			                 return grid.grid({
			                        ...
			                        url:'${pageContext.request.contextPath}/LotSummary/Substrate/getSplit/'+id+'.koala',
			                        columns: [
			                           ...
			                           'modify': function(event, data){
			                                ...
			                                window.open("/pages/LotSummary.jsp?id="+indexs[0]);
			                            }
			                 });
			            }
			        };
		        ...
		        PageLoader = {
		            initGridPanel: function(){
		                 ...
		                 return grid.grid({
		                        ...
		                        url:'${pageContext.request.contextPath}/LotSummary/Substrate/getMerge/'+id+'.koala',
		                        columns: [
		...
		$(".glyphicon-info-sign").bind("click",function(){
			...
			var id=$(this).attr("lotId");
			$.get('${pageContext.request.contextPath}/LotSummary/Substrate/getHold/'+id+'.koala').done(function(msg){
		...
		$.get('${pageContext.request.contextPath}/LotSummary/Substrate/getReject/'+id+'.koala').done(function(msg){
