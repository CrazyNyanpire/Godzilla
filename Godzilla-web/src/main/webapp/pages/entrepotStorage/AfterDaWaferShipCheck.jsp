...
<p>Start:</p>
	           <div class="form-group">
                    <label class="col-lg-2 control-label">Ship Qty:</label>
                    <div class="col-lg-9">
                            <input name="shipQty" style="display:inline; width:94%;" class="form-control"  type="text"  id="shipQtyID" dataType="Require"></textarea>
                           <span class="required">*</span>
    </div>
</div>
	           <div class="form-group">
                    <label class="col-lg-2 control-label">Carton Qty:</label>
                    <div class="col-lg-9">
                           <input name="cartonQty" style="display:inline; width:94%;" class="form-control"  type="text"  id="cartonQtyID" dataType="Require"></input>
                           <span class="required">*</span>
    </div>
</div>
	           <div class="form-group">
                    <label class="col-lg-2 control-label">Partial Carton Box Qty:</label>
                    <div class="col-lg-9">
                           <input name="partialQty" style="display:inline; width:94%;" class="form-control"  type="text"  id="partialQtyID" dataType="Require"></input>
                           <span class="required">*</span>
    </div>
</div>
	           <div class="form-group">
                    <label class="col-lg-2 control-label">Sample Size:</label>
                    <div class="col-lg-9">
                           <input name="sampleSize" style="display:inline; width:94%;" class="form-control"  type="text"  id="sampleSizeID" dataType="Require"></input>
                           <span class="required">*</span>
    </div>
</div>
	           <div class="form-group">
...
contents.push({title:'Ship Lot to Customer' , value: '1101'});
contents.push({title:'Ship Lot to Test' , value: '1201'});
//selectItems['starFlowID'] = contents;
</script>
</body>
</html>