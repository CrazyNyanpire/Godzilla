	   ...
	   //
	    ...
	    initGridPanelone: function(){
	         ...
	         return grid.grid({
	                ...
	                url:"${pageContext.request.contextPath}/MaterialProcess/Process/pageJson/"+AlphaId+".koala",
	                columns: [
	                         	 { title: 'Material No', name: 'lotNo', width: 80},
	 	                         ...
	 	                         { title: 'Balance', name: 'balance', width: 65, render: function (rowdata, name, index){
			                    		  return rowdata[name].toFixed(2);
			                      }},
	                    ...
	                    'Lot_Summary': function(event, data){
	                    	...
	                    	window.open("/pages/MateriaLotSummary.jsp?id="+indexs[0]+"&stationId=" + AlphaId); 
	                    }
	               ...
	               $.get( '${pageContext.request.contextPath}/MaterialProcess/get/' + id + '.koala').done(function(json){
	                ...
	                dialog.find('#save').on('click',{grid: grid}, function(e){
	                    ...
	                    rs['data']=inobj;
	  	          		...
	  	          		debugger;
	                    $.post('${pageContext.request.contextPath}/MaterialProcess/Process/changeLotType.koala', "data="+restring).done(function(result){
	               ...
	               $.get( '${pageContext.request.contextPath}/MaterialProcess/get/' + id + '.koala').done(function(json){
	                ...
	                dialog.find('#save').on('click',{grid: grid}, function(e){
	                    ...
	                    rs['data']=inobj;
	  	          		var restring=JSON.stringify(rs);
	  	          		debugger;
	                    $.post('${pageContext.request.contextPath}/MaterialProcess/Process/changeLocations.koala', "data="+restring).done(function(result){
	               ...
	               $.get( '${pageContext.request.contextPath}/MaterialProcess/get/' + id + '.koala').done(function(json){
	                ...
	                dialog.find('#save').on('click',{grid: grid}, function(e){
	                    ...
	                    rs['data']=inobj;
	  	          		var restring=JSON.stringify(rs);
	  	          		debugger;
	                    $.post('${pageContext.request.contextPath}/MaterialProcess/Process/release.koala', "data="+restring).done(function(result){
	                        if(result.result == 'success'){
	                            dialog.modal('hide');
	                            e.data.grid.data('koala.grid').refresh();
	                            e.data.grid.message({
	        ...
	        $.get('/pages/inOut/UserInformation.jsp').done(function(html){
	               ...
	               /*$.get( '${pageContext.request.contextPath}/MaterialProcess/get/' + id + '.koala').done(function(json){
	                ...
	                dialog.find('#save').on('click',{grid: grid}, function(e){
	                    ...
	                    if(AlphaId=='205')
	                    	{
	                    		rs['nextStationId']='103';
	                    		rs['currStatus']='Pass';
	                    	}
	                    else{
	                    	rs['nextStationId']='205';
	                    }
	  	          		var restring=JSON.stringify(rs);
	  	          		debugger;
	    ...
	    Cus_Hold: function(id, grid){
	        ...
	        $.get('<%=path%>/DerectCusHold.jsp').done(function(html){
	               dialog.find('.modal-body').html(html);
	               self.initPage(dialog.find('form'));
	               $.get( '${pageContext.request.contextPath}/MaterialProcess/get/' + id + '.koala').done(function(json){
                       json = json.data;
	               ...
	               $.get( '${pageContext.request.contextPath}/MaterialProcess/get/' + id + '.koala').done(function(json){
	                ...
	                dialog.find('#save').on('click',{grid: grid}, function(e){
	                    ...
	                    rs['data']=inobj;
	  	          		var restring=JSON.stringify(rs);
	  	          	    debugger;
	                    $.post('${pageContext.request.contextPath}/MaterialProcess/Process/future.koala', "data="+restring).done(function(result){
	                    	messagecheck(e,result,dialog);
	                    });
	                });
	        });
	               ...
	               $.get( '${pageContext.request.contextPath}/MaterialProcess/get/' + id + '.koala').done(function(json){
	                ...
	                dialog.find('#save').on('click',{grid: grid}, function(e){
	                    ...
	                    rs['id']=id;
	  	          		var restring=JSON.stringify(rs);
	  	          		debugger;
	                    $.post('${pageContext.request.contextPath}/MaterialProcess/Process/update.koala', "data="+restring).done(function(result){
	                    	messagecheck(e,result,dialog);
	                    });
	                });
	        });
	               ...
	               $.get( '${pageContext.request.contextPath}/MaterialProcess/get/' + id + '.koala').done(function(json){
	                ...
	                dialog.find('#save').on('click',{grid: grid}, function(e){
	                    ...
	                    rs['id']=id;
	  	          		var restring=JSON.stringify(rs);
	  	          		debugger;
	                    $.post('${pageContext.request.contextPath}/MaterialProcess/update.koala', "data="+restring).done(function(result){
	                        if(result.result == 'success'){
	                            dialog.modal('hide');
	                            e.data.grid.data('koala.grid').refresh();
	                            e.data.grid.message({
  ...
  <tr>
    <td>
          ...
          <div class="form-group">
                      <label class="control-label" style="width:100px;float:left;text-align:left;padding-left:4%;">Material No:&nbsp;</label>
            <div style="margin-left:15px;float:left;">
