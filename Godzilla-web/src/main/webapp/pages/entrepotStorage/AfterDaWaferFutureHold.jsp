...
<hr/>
<p>Choose The Future Hold Flow Point:</p>
	           <div class="form-group">
                    <label class="col-lg-2 control-label">Select a Hold Station:</label>
                    <div class="col-lg-9">
                    <div class="btn-group select" id="futureStationIdID"></div>
                           <input type="hidden" name="futureStationId" id="futureStationIdID_" dataType="Require"/>
...
$.ajax({
	async:false,
	url: '${pageContext.request.contextPath}/ManufactureProcess/getFutureStations/'+id+'.koala',
	type: 'POST',
	dataType: 'json',
})
.done(function(msg) {
	...
	selectItems['futureStationIdID'] = contents;
});
var contents = [{title:'请选择', value: ''}];
$.ajax({
	async:false,
	url: '${pageContext.request.contextPath}/ManufactureProcess/Process/getCusDisps.koala',
	type: 'POST',
	dataType: 'json',
})
.done(function(msg) {
	...
	$.ajax({
		async:false,
		url: '${pageContext.request.contextPath}/ManufactureProcess/Process/getEngDisps.koala',
		type: 'POST',
		dataType: 'json',
	})
	.done(function(msg) {
