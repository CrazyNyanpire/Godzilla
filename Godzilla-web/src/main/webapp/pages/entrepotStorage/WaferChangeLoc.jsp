...
<p>Select a Loc:</p>
	           <div class="form-group">
                    <label class="col-lg-2 control-label">Change To Loc:</label>
                    <div class="col-lg-9">
                    <div class="btn-group select" id="locationIdsID"></div>
                           <input type="hidden" name="locationIds" id="locationIdsID_" dataType="Require"/>
	           ...
	           <div class="form-group">
                    ...
                    <div class="col-lg-9">
                           <textarea name="comments" style="display:inline; width:94%;" class="form-control"  type="text"  id="commentsID" dataType="Require" autofocus></textarea>
                           <span class="required">*</span>
    </div>
</div>
	           <div class="form-group">
