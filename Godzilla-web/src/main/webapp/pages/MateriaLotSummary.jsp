...
<h3  style="text-align: center;">Lot Summary</h3>
	...
	<div style="margin:0 auto;width:90%">
        <label class="control-label" style="width:100px">Material No:</label>
            <div style="margin-left:15px;float:left;">
            <input name="lotNumber"  type="text" style="width:180px;" id="lotNumberID"  />
        	</div>
        <label class="control-label" style="width:100px">Batch N.:</label>
            <div style="margin-left:15px;float:left;">
            <input name="batchNo"  type="text" style="width:180px;" id="batchNoID"  />
        	</div>
        <label class="control-label">Part N.:</label>
            <div style="margin-left:15px;float:left;">
            <input name="partId"  type="text" style="width:180px;" id="partIdID"  />
        	</div>
		<br style="clear:both;"/>
	</div>
	</div>
...
$(function() {
	...
	$.ajax({
		async:false,
		url: '${pageContext.request.contextPath}/MaterialProcess/get/' + id + '.koala',
		type: 'GET',
		dataType: 'json',
	}).done(function(msg) {
		debugger;
		...
		$("input[name='partId']").val(basicInfo['partId']);
	});
	$.ajax({
		async:false,
		url: '${pageContext.request.contextPath}/LotSummary/Material/getLotSummary/' + id + '.koala',
		type: 'GET',
		dataType: 'json',
	}).done(function(msg) {
		//var msg={};
			        ...
			        PageLoader = {
			            initGridPanel: function(){
			                 ...
			                 return grid.grid({
			                        ...
			                        url:'${pageContext.request.contextPath}/LotSummary/Material/getSplit/'+id+'.koala',
			                        columns: [
		        ...
		        PageLoader = {
		            initGridPanel: function(){
		                 ...
		                 return grid.grid({
		                        ...
		                        url:'${pageContext.request.contextPath}/LotSummary/Material/getMerge/'+id+'.koala',
		                        columns: [
		...
		$(".glyphicon-info-sign").bind("click",function(){
			...
			var id=$(this).attr("lotId");
			$.get('${pageContext.request.contextPath}/LotSummary/Material/getHold/'+id+'.koala').done(function(msg){
		...
		$.get('${pageContext.request.contextPath}/LotSummary/Material/getReject/'+id+'.koala').done(function(msg){
